...
// Middleware para limitar solicitudes (rate limiter)
...
// Middleware para detectar y bloquear IPs que realicen demasiadas solicitudes
const trackRequests = (req, res, next) => {
  ...
  // Si han pasado menos de 60 segundos desde la última solicitud y la IP ha realizado más de 1000 solicitudes
  ...
  // Si han pasado más de 60 segundos, restablece el contador de solicitudes
...
// Aplica el middleware de tracking de IPs
app.use(trackRequests);

// Middleware para la protección contra lentitud de solicitudes (slow down)
...
// Aplica el slow down a todas las rutas
